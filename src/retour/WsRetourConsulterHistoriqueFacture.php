...
use PhpChorusPiste\IModeDepot;
use PhpChorusPiste\IStatutCourantCode;

/**
 * @property int                                                     idFacture
 * @property string                                                  numeroFacture
 * @property string|\PhpChorusPiste\IModeDepot                       modeDepot
 * @property string|\PhpChorusPiste\IStatutCourantCode               statutCourantCode
 * @property \PhpChorusPiste\Retour\HistoriquesStatus[]              historiquesDesStatuts
 * @property \PhpChorusPiste\Retour\HistoriquesEvenements[]          historiquesDesEvenementsComplementaires
 * @property \PhpChorusPiste\Retour\HistoriquesActionsUtilisateurs[] historiquesDesActionsUtilisateurs
 * @property \PhpChorusPiste\Retour\DerniereAction                   derniereAction
 */
