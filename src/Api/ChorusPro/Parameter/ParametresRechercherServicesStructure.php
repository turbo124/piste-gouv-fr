...
//    ];
     ...
     */
    public function __construct(int $pageResultatDemandee = 0, int $nbResultatsParPage = 0, string $triSens = self::TRISENS_DESC, string $triColonne = self::TRICOLONNE_CODESERVICE, array $champsDeTri = [], string $ordreTriGenerique = self::TRISENS_DESC, int $taillePageGenerique = 0, int $indexPageGenerique = 0) {
