...
//    die();
    ...
    try {
        ...
        $soumettreFactureResult = $Factures->soumettreFacture(0,
                                                              ...
                                                              new \PisteGouvFr\Api\ChorusPro\Parameter\SoumettreFactureReferences($deviseFacture, \PisteGouvFr\Api\ChorusPro\Type\ITypeFacture::FACTURE, \PisteGouvFr\Api\ChorusPro\Type\ITypeIdentifiantStructure::TVA_SUR_ENCAISSEMENT, null, '', $numeroBonCommande, $numeroFacture, \PisteGouvFr\Api\ChorusPro\Type\IModePaiement::VIREMENT),
